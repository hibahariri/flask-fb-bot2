        ...
        bot.send_generic_message(recipient_id, [
            {
                ...
                "image_url": "https://maps.googleapis.com/maps/api/staticmap?size=100x70&markers=color:blue%7Clabel:S%7C&" + address + "&key=AIzaSyB16ffMqfvPJ4cgTFyyNpllAbq3f-V1q-o",
                "subtitle": "address",
                "buttons":
                    [
                        {
